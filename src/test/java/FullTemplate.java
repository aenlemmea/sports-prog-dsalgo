...
class FullHyperPrinter extends java.io.PrintWriter{
    public FullHyperPrinter(java.io.PrintStream stream){
        super(stream);
    }
    public FullHyperPrinter(java.io.File file) throws java.io.FileNotFoundException{
        super(new java.io.PrintStream(file));
    }
    public FullHyperPrinter(){
        super(System.out);
    }
...
class FullHyperScanner {
    ...
    public FullHyperScanner(java.io.InputStream in){
        this.in = in;
    }
    public FullHyperScanner(java.io.File file) throws java.io.FileNotFoundException {
        this(new java.io.BufferedInputStream(new java.io.FileInputStream(file)));
    }
    public FullHyperScanner(){
        this(System.in);
    }
